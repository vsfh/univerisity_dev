...
- generates descriptions for the first 150 test cases into `auto_prompt/generated_descriptions/`
- loads `/media/data1/feihong/remote/ckpt/model_test_geo_input_ids/last.pth`
...
```bash
python -m auto_prompt.evaluate_prompt \
  --checkpoint /media/data1/feihong/remote/ckpt/model_test_geo_input_ids/last.pth \
  --max-cases 150 \
  --candidate-size 50 \
