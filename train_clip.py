...
class TargetSearchDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        text_inputs = self.processor(text=text_description, return_tensors="pt", padding="max_length", truncation=True, max_length=77)
        ...
        for img_path in tqdm(eval_list):
            ...
            if os.path.exists(search_path):
                try:
                    ...
                    text_inputs = processor(text=text_description, return_tensors="pt", padding="max_length", truncation=True, max_length=77)
