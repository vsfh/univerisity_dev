...
def load_success_filenames():
    ...
    success_set = set()
    success_file = "/media/data1/feihong/remote/univerisity_dev/eval_success_unified.txt"
...
def load_model(checkpoint_path: str, device: str):
    ...
    # checkpoint_path = "/media/data1/feihong/remote/ckpt/unified_siglip_abla_ap/best_iou_41.pth"
    # checkpoint_path = "/media/data1/feihong/remote/ckpt/unified_siglip_heading/best_iou_44.pth"
...
def evaluate_model(
    ...
    test_bbox_dict = json.load(
        open("/media/data1/feihong/remote/univerisity_dev/runs/test.json", "r")
    )
...
def main():
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="/media/data1/feihong/remote/ckpt/supp_0.9/last.pth",
        help="Path to model checkpoint",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/media/data1/feihong/remote/univerisity_dev/eval_results",
