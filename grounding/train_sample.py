...
@desc Training SampleGeoLite on GroundSmgeoDataset with geo conditioning.
"""
...
def main(args):
    ...
    model = SampleGeoLite(emb_size=1024).to(DEVICE)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="SampleGeoLite Training on GroundSmgeoDataset with Geo Conditioning"
    )
