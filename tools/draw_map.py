...
def get_world_map_two():
    ...
    input_folder = "/media/data1/feihong/remote/new_univ_kml"
    kml_files = [
        os.path.join(input_folder, f)
        for f in os.listdir(input_folder)
        if f.lower().endswith(".kml")
...
def match_libraries():
    ...
    library_file = "/media/data1/feihong/remote/univerisity_dev/asian_200_libraries_free.txt"
    output_file = "/media/data1/feihong/remote/univerisity_dev/matched_university_libraries.txt"
...
def collect_spread_university_targets(
    input_file: str = "/media/data1/feihong/remote/ckpt/matched_university_libraries.txt",
...
def write_drone_folder_names_to_train_txt(
    source_dir: str = "/media/data1/feihong/remote/drone_view/drone",
    output_file: str = "/media/data1/feihong/remote/ckpt/train.txt",
